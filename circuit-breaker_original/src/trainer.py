...
class InfinityTrainer(object):
    ...
    def train_step(
        ...
        inp_B3HW: FTen, text_cond_tuple: Union[ITen, FTen], args: arg_util.Args, circuit_breaker_loss: Optional[torch.Tensor] = None,
        ...
        with self.gpt_opt.amp_ctx:
            ...
            # Add circuit breaker loss if provided
            if circuit_breaker_loss is not None:
                loss = loss + circuit_breaker_loss
